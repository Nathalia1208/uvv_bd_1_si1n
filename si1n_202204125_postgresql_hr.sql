...
---INTRODUÇÃO DA DATABASE LIGADA A ESTE USUARIO---
...
CREATE SCHEMA hr AUTHORIZATION nathalia;
...
---CRIAÇÃO DAS TABELAS VINCUALADAS AO SCHEMA CRIADO---
...
COMMENT ON COLUMN hr.paises.id_pais IS 'codigo do pais';
COMMENT ON COLUMN hr.paises.nome_pais IS 'nome do pais';
COMMENT ON COLUMN hr.paises.id_regiao IS 'codigo da regiao';
...
COMMENT ON COLUMN hr.localizacoes.id_localizacao IS 'codigo das localizacoes';
COMMENT ON COLUMN hr.localizacoes.endereco IS 'endereco';
COMMENT ON COLUMN hr.localizacoes.uf IS 'uf';
COMMENT ON COLUMN hr.localizacoes.cidade IS 'cidade onde se encontra';
...
COMMENT ON TABLE hr.departamentos IS 'Tabela Departamento onde os empregados execem sua funcao';
COMMENT ON COLUMN hr.departamentos.id_departamento IS 'codigo do departamento';
COMMENT ON COLUMN hr.departamentos.nome IS 'nome do departamento';
COMMENT ON COLUMN hr.departamentos.id_localizacao IS 'codigo das localizacoes';
...
COMMENT ON TABLE hr.empregado_departamento IS 'Tabela de ligação da relação entre empregados e departamentos.'; 

COMMENT ON COLUMN hr. hr.dep_empregado.id_departamento IS 'Chave estrangeira para a tabela departamentos.'; 

COMMENT ON COLUMN hr.dep_empregado.id_empregados IS 'Chave primária da tabela.'; 
...
COMMENT ON COLUMN hr.historico_cargos.id_empregado IS 'codigo do empregado';
...
---INTRODUÇÃO DE DADOS NA TABELA REGIOES---
...
---INTRODUÇÃO DE DADOS NA TABELA PAISES---
...
---INTRODUÇÃO DE DADOS NA TABELA LOCALIZACOES---
...
---INTRODUÇÃO DE DADOS NA TABELA CARGOS---
...
---INTRODUÇÃO DE DADOS NA TABELA EMPREGADOS---

INSERT INTO hr.empregados (id_empregado, nome, email,telefone, data_contratacao, id_cargo, salario,comissao, id_supervisor, id_departamento) VALUES(100,'StevenKing','SKING','515.123.4567', '2003-06-17', 'AD_PRES', 24000, null, null, 90);
...
---INTRODUÇÃO DE DADOS NA TABELA HISTORICO CARGOS---
