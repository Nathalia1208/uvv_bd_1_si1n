CREATE USER Nathalia;

CREATE DATABASE uvv_1;

GRANT ALL PRIVILEGES ON uvv_1.*TO Nathalia;

USE uvv_1;

/*---CRIAÇÃO DAS TABELA REGIOES---*/
...
ALTER TABLE regioes COMMENT 'Tabela que documenta as regioes em que a empresa opera ';
ALTER TABLE regioes COMMENT 'codigo que simboliza cada regiao';
ALTER TABLE regioes COMMENT 'nome da regiao';
...
ALTER TABLE paises COMMENT 'Tabela que caracteriza os paises que funciona';
ALTER TABLE paises COMMENT 'codigo que simboliza cada pais';
ALTER TABLE paises COMMENT 'nome do pais';
ALTER TABLE paises COMMENT 'codigo da regiao de cada pais ';
...
ALTER TABLE localizacoes COMMENT 'tabela de localizao de paises';
ALTER TABLE localizacoes COMMENT'codigo de localizacoes ';
ALTER TABLE localizacoes COMMENT'endereco';
ALTER TABLE localizacoes COMMENT 'uf';
ALTER TABLE localizacoes COMMENT'cidade';
ALTER TABLE localizacoes COMMENT 'Cpf';
ALTER TABLE localizacoes COMMENT 'id do pais';
...
ALTER TABLE departamentos COMMENT 'Tabela Departamento onde os empregados trabalham';
ALTER TABLE departamentos COMMENT 'codigo  do departamento';
ALTER TABLE departamentos COMMENT 'nome do departamento';
ALTER TABLE departamentos COMMENT 'codigo das localizacoes';
...
ALTER TABLE cargos COMMENT 'Tabela de Cargos do funcionario';
ALTER TABLE cargos COMMENT  'codigos do cargos';
ALTER TABLE cargos COMMENT  'Cargos do empresario';
ALTER TABLE cargos COMMENT  'Salario minimo';
ALTER TABLE cargos COMMENT  'Salario maximo';
...
ALTER TABLE empregados COMMENT 'Tabela empregados, onde estara armazenado  todos os funcionarios';
ALTER TABLE empregados COMMENT 'Id do empregado';
ALTER TABLE empregados COMMENT 'Email do empregado';
ALTER TABLE empregados COMMENT  'nome do empregado';
ALTER TABLE empregados COMMENT 'Telefone do empregado';
ALTER TABLE empregados COMMENT 'Salario do empregado';
ALTER TABLE empregados COMMENT 'Comissao do empregado';
ALTER TABLE empregados COMMENT 'Id_supervisor';
ALTER TABLE empregados COMMENT 'Id do cargo';
ALTER TABLE empregados COMMENT 'Id do departamento';
...
ALTER TABLE historico_cargos COMMENT 'Tabela do historico do cargo do empregado';
ALTER TABLE historico_cargos COMMENT 'data_inicial';
ALTER TABLE historico_cargos COMMENT 'Id do empregado';
ALTER TABLE historico_cargos COMMENT 'data final';
ALTER TABLE historico_cargos COMMENT 'Id do cargo';
ALTER TABLE historico_cargos COMMENT 'Id do departamento';



/*---Indrodução DE DADOS NA TABELA REGIOES---*/
...
/*---Indrodução DE DADOS NA TABELA PAISES---*/
...
/*---Indrodução DE DADOS NA TABELA LOCALIZACOES---*/
...
Insert into localizacoes (id_localizacao, endereco, cep, cidade, uf, id_pais) values (2700,'Schwanthalerstr. 7031','80925','Munich','Bavaria','BE');
...
/*---Indrodução DE DADOS NA TABELA DEPARTAMENTO---*/
...
/*---Indrodução DE DADOS NA TABELA CARGOS---*/
...
/*---CONSTRAINTS DA TABELA EMPREGADO---*/



/*---INSERÇÃO DE DADOS NA TABELA EMPREGADOS---*/

INSERT INTO empregados (id_empregado, nome, email,telefone, data_contratacao, id_cargo, salario,comissao, id_supervisor, id_departamento) VALUES(100,'StevenKing','SKING','515.123.4567', '2003-06-17', 'AD_PRES', 24000, null, null, 90);
...
/*---CONSTRAINTS DAS TABELAS EMPREGADOS E HISTORICO_CARGOS---*/
...
/*---Indrodução DE DADOS NA TABELA HISTORICO CARGOS---*/
...
insert into historico_cargos (id_empregado, data_inicial, data_final, id_cargo, id_departamento) values
( 176, '2006-03-25','2006-12-31','SA_REP', 80
);
insert into historico_cargos (id_empregado, data_inicial, data_final, id_cargo, id_departamento) values
